...
#define DB_LOG2_ENERGY                                                         \
  (3.01029995663981154631945610163) /* dB = DB_LOG2_ENERGY*__log2(energy) */
#define DB_LOG2_AMPL                                                           \
  (6.02059991327962309263891220326) /* dB = DB_LOG2_AMPL*__log2(amplitude) */
#define ONE_OVER_DB_LOG2_AMPL                                                  \
  (0.16609640474436811218256075335) /* amplitude =                             \
                                       __exp2(ONE_OVER_DB_LOG2_AMPL*dB) */
